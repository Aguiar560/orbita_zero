...
export const EVENTOS: readonly EventoDef[] = [
  ...
  { id: 'mare_corrosiva', nome: 'Maré Corrosiva', subtitulo: 'JANELA QUÍMICA', cor: '#62d7a4', ritmo: 'diario', recurso: 'uranio', quantidade: 22, setorMinimo: 1, modificador: 'Corrosão contínua no casco · depósitos instáveis', objetivo: { fato: 'abate', alvo: 290, filtro: { elemento: 'quimico' }, texto: 'Abater 290 inimigos químicos' }, descricao: 'O que corrói a nave também dissolve a rocha que prende o urânio da Fenda de Rhodes.' },
  { id: 'dobra_curta', nome: 'Dobra Curta', subtitulo: 'JANELA CÓSMICA', cor: '#b58cff', ritmo: 'diario', recurso: 'platina', quantidade: 20, setorMinimo: 1, modificador: 'Inimigos cósmicos surgem fora de posição · pressão elevada', objetivo: { fato: 'abate', alvo: 220, filtro: { elemento: 'cosmico' }, texto: 'Abater 220 inimigos cósmicos' }, descricao: 'A dobra comprime uma galáxia inteira por um dia. A platina da Coroa Quebrada vem junto.' },
  { id: 'silencio_balistico', nome: 'Silêncio Balístico', subtitulo: 'JANELA NEUTRA', cor: '#b8c4cf', ritmo: 'diario', recurso: 'titanio', quantidade: 22, setorMinimo: 11, modificador: 'Sem vantagem elemental · dano normal +12%', objetivo: { fato: 'abate', alvo: 210, filtro: { elemento: 'padrao' }, texto: 'Abater 210 inimigos sem elemento' }, descricao: 'Nada resiste, nada favorece. Só massa contra massa — e o titânio que sobra dela.' },
