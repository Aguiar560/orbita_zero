...
export const EVENTOS: readonly EventoDef[] = [
  ...
  { id: 'festival_sinal', nome: 'Festival do Sinal', subtitulo: 'FREQUÊNCIA ABERTA', cor: '#ff65d8', gas: 'neonio', quantidade: 38, setorMinimo: 50, modificador: '+25% cápsulas de patrulha', objetivo: { fato: 'bau', alvo: 10, texto: 'Abrir 10 baús' }, descricao: 'Balizas de néon marcam rotas temporárias entre mercadores e caçadores.' },
