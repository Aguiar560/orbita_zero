...
export const HULLS: readonly Hull[] = [
  ...
  },
  {
    ...
    trail: '#ff5a3d',
    shot: TESLA,
    stats: { dano: 52, cadencia: 4.8, vida: 210, escudo: 90, regen: 5, velocidade: 300, projeteis: 3, critChance: 0.25, critDano: 1.0, explosao: 26 },
    cost: 900,
    requiresSector: 55,
  },
  {
    ...
    stats: {
      dano: 90, cadencia: 4.2, vida: 420, escudo: 380, regen: 22, velocidade: 290,
      projeteis: 4, perfuracao: 4, critChance: 0.2, critDano: 0.8, explosao: 34, sorte: 0.4, iaSkill: 0.15,
    },
    cost: 2400,
    requiresSector: 70,
  },
  ...
  },
  {
    ...
    stats: {
      dano: 40, cadencia: 3.9, vida: 200, escudo: 150, regen: 7, velocidade: 275,
      projeteis: 3, perfuracao: 4, critChance: 0.26, critDano: 0.9, danoCosmico: 0.2,
    },
    cost: 860,
    requiresSector: 44,
  },
  {
    ...
    stats: {
      dano: 62, cadencia: 4.4, vida: 340, escudo: 260, regen: 26, velocidade: 265,
      projeteis: 3, perfuracao: 2, iaSkill: 0.18, danoQuimico: 0.25, resQuimico: 0.2,
    },
    cost: 1600,
    requiresSector: 58,
  },
