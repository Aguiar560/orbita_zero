...
export interface ChestDef {
   ...
   *
   * Nunca cristal. Os baús caem de chefe repetido e de missão, e a cápsula é
   * VENDIDA por cristal — pôr cristal dentro dela era um ganho repetível e um
   * desconto escondido na mesma linha. Ver `balance/cristal.ts`.
   */
  resources: Partial<Record<Exclude<ResourceId, 'cristal'>, number>>;
...
export const CHESTS: readonly ChestDef[] = [
  ...
  },
  {
    ...
    resources: { sucata: 300, nucleo: 22 }, buy: 15,
  },
  {
    ...
    resources: { sucata: 1100, nucleo: 90 }, buy: 60,
  },
  {
    ...
    resources: { sucata: 5000, nucleo: 420 }, buy: 240,
  },
];
